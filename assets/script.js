...
const translations = {
    "cs": {
        ...
        "podnadpis-praxe": "Pracovní zkušenosti",
        "podnadpis-vzdelani": "Vzdělání",
        "status-soucasnost": "Současnost",
        "cv-stahnout": "Stáhnout CV (A4)",
        ...
        "lang-cz": "Čeština (Rodilý mluvčí)",
        "lang-en": "Angličtina (C1)",
        "lang-de": "Němčina (B1)",
        ...
        "exp-mgr-title": "Navazující magisterské studium (Ing.)",
        "exp-mgr-company": "Univerzita Pardubice, Fakulta ekonomicko-správní",
        "exp-mgr-desc": "Studijní program Aplikovaná informatika - Data Science pro business. Zaměření na business intelligence, metody umělé inteligence, analýzu datových zdrojů a kybernetickou bezpečnost.",
    },
    "en": {
        "nav-uvod": "Home",
        "nav-omne": "About",
        ...
        "podnadpis-praxe": "Work Experience",
        "podnadpis-vzdelani": "Education",
        "status-soucasnost": "Present",
        "cv-stahnout": "Download CV (A4)",
        ...
        "exp-mgr-title": "Master's Degree (Ing.)",
        "exp-mgr-company": "University of Pardubice, Faculty of Economics and Administration",
        "exp-mgr-desc": "Applied Informatics - Data Science for Business study program. Focus on business intelligence, artificial intelligence methods, data source mining, and cybersecurity.",
    }
};
